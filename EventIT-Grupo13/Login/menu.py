...
from Monitoreo.M_Sensores import Sensor
...
def menu():
    ...
    """
    print(menugraf)
    option = int(input("Elija una option : "))
    if option == 1:
        menu1_0()
    elif option == 2:
        menu2_0()
...
class MenuCiudadano:
    ...
    def getCiudadano(self):
        return Ciudadano(self.name)
...
class MenuSolicitudes:
    ...
    def menu1_1_1(self):
        ...
        if option == 1:
            print()
            print(Ciudadano(self.name).getfriends())
            self.menu1_1_1()
        elif option == 2:
            try:
...
class MenuEventos:
    ...
    def menu1_1_2(self):
        ...
        if option == 1:
            ...
            print()
            print(Sensor().getEvents().to_markdown())
            self.menu1_1_2()
        elif option == 3:
            print()
            print(Sensor().getApprovedEvents().to_markdown())
            self.menu1_1_2()
        elif option == 4:
            ...
            Sensor().addEvent(event_type, x, y, description)
            print("\n¡Evento creado!")
            self.menu1_1_2()
        elif option == 5:
            ...
            if a == "y":
                event_type = input("Nombre del evento: ").strip()
                name = input("Nombre de quien reporta: ").strip()
                Sensor().reportEvent(event_type, [name])
                print("\nEvento reportado...")
            self.menu1_1_2()
        elif option == 6:
            ...
            if a == "y":
                ...
                Sensor().reportEvent(event_type, friends)
                print("\nEvento reportado...")
            self.menu1_1_2()
        elif option == 7:
            try:
                event_type = input("Nombre del evento: ").strip()
                Sensor().delreportEvent(event_type, self.name)
                print("\nReporte eliminado...")
            except (KeyError, ):
                print("\nEvento no encontrado...")
            except (Exception,):
                print("\nUsted no se encuentra reportado en ese evento...")
            self.menu1_1_2()
        elif option == 8:
...
class MenuMapas:
    ...
    def menu1_1_2_7(self):
        ...
        (3) Ver ranking
        (4) Ver ranking (mapa)
        (5) Ver ranking por zona
        (6) Ver ranking por zona (mapa)
        (0) Salir
        {separator}
        """
        ...
        if option == 1:
            ...
            print(sortDatabase('DB_evento').to_markdown())
            self.menu1_1_2_7()
        elif option == 4:
            createBar()
            self.menu1_1_2_7()
            ...
            try:
                x = int(input("Coordenada X: "))
                y = int(input("Coordenada Y: "))
                print(sortDatabase_coords('DB_evento', x, y).to_markdown())
            except (Exception,):
...
class MenuAdmin:
    ...
    def menu2_1(self):
        ...
        if option == 1:
            ...
            try:
                Admin(self.name).setAlta(evento)
            ...
            evento = input("""Ingrese evento: """).strip()
            try:
                Admin(self.name).setBaja(evento)
